...
contract InitPTokenReserve is Script {
    function run() external {
        ...
        for (uint i; i < tokens.length; ++i) {
            ...
            inputs[i] = ConfiguratorInputTypes.InitReserveInput(
                ...
                string(abi.encodePacked("Kinza", "P", tokens[i])),
                string(abi.encodePacked("k", "P", tokens[i])),
                string(abi.encodePacked("Kinza Variable Debt ", "P", tokens[i])),
                string(abi.encodePacked("vDebt", "P", tokens[i])),
                string(abi.encodePacked("Kinza Stable Debt ", "P", tokens[i])),
                string(abi.encodePacked("sDebt", "P", tokens[i])),
